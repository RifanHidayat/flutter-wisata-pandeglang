...
class UpdateRencana extends StatefulWidget {
  UpdateRencana({
    this.lama_wisata,
    this.alokasi_dana,
  ...
  var id,nama_rencana,lama_wisata,alokasi_dana,jumlah_wisatawan,tanggal,jumlah_kendaraan,pilih_kendaraan,pilih_wisata,id_kendaran,id_wisata;
  @override
  _UpdateRencanaState createState() => _UpdateRencanaState();
}
...
class _UpdateRencanaState extends State<UpdateRencana> {
    ...
    return Container(
      ...
      child: OutlineButton(
        ...
        onPressed: () {
          ...
          validasi.validasi_update_rencana(context, Cname.text,
              dana, Clama.text, Cjml.text,
              Cdate.text.toString().trim(), "", currentlat.toString().trim(), currenlong.toString().trim(),
              kendaraan_id.toString().trim(), wisata_id.toString().trim(), Cjmlkendaraan.text.toString().trim(), user_id.toString().trim(),widget.id);
...
_listKendaraan(index){
  ...
  getDataPref() async {
    ...
    setState(() {
      ...
      Clama.text=widget.lama_wisata;
      Cjml.text=widget.jumlah_wisatawan;
      Cdate.text=widget.tanggal;
      Ckendaraan.text=widget.pilih_kendaraan;
      wisata_id=widget.id_wisata;
      kendaraan_id=widget.id_kendaran;
      Cdana.text=widget.alokasi_dana;
      Cjmlkendaraan.text=widget.jumlah_kendaraan;
      Cname.text=widget.nama_rencana;
      Cpilih.text=widget.pilih_wisata;
